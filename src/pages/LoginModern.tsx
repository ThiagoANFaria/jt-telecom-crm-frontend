      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-3xl lg:text-4xl font-bold text-[#2C2C2C] leading-tight">
              Sua comunicação.
          ...
          <div className="space-y-3 max-w-sm mx-auto">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[#2C2C2C] font-medium text-sm">Sistema de telefonia integrado</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-[#00C853] rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-white text-xs font-bold">✓</span>
              </div>
              <span className="text-[#2C2C2C] font-medium text-sm">CRM completo e intuitivo</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 bg-[#00C853] rounded-full flex items-center justify-center flex-shrink-0">
                <span className="text-white text-xs font-bold">✓</span>
              </div>
              <span className="text-[#2C2C2C] font-medium text-sm">Atendimento automatizado inteligente</span>
            </div>
          </div>

          {/* Card do Login */}
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 sm:p-8 transform hover:scale-[1.02] transition-all duration-300">
            {/* Header do Card */}
            <div className="text-center mb-6">
              <h2 className="text-xl sm:text-2xl font-bold text-[#2C2C2C] mb-2">Acesse sua conta</h2>
              <p className="text-gray-600 text-sm">Entre para continuar sua jornada</p>
            </div>
