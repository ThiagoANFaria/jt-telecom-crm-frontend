...
import { Crown, Shield, Lock, RefreshCw, LogOut } from 'lucide-react';
...
const MasterLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-jt-blue p-4 relative">
      {/* Botão de logout quando usuário está logado */}
      {user && (
        <div className="absolute top-4 right-4 z-10">
          <div className="flex flex-col items-end gap-2">
            <p className="text-white text-sm bg-black/20 backdrop-blur-sm px-3 py-1 rounded-lg">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white hover:text-jt-blue transition-all"
            >
